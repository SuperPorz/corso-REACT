...
function Card() {
    return(
        <article className="cardSection">
            <h2>Sottotitolo</h2>
            <img src="https://images.pexels.com/photos/21554935/pexels-photo-21554935/free-photo-of-paesaggio-tramonto-moda-uomo.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" width="200px" height="200px" className="avatar"/>
            <p className="testP">Par 1</p>
            <p>Par2</p>
        </article>
    );
}
...
import cardClasses from './Card.module.css'; //cardClasses è inventato da noi in questa riga, si crea un oggetto JS

const person = {
    name: 'Luca',
    surname: 'Rosi',
    age: 24,
    email: 'paolorosi@top.com',
